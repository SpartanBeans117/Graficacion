...
plataformas = [
    ...
    pygame.Rect(0, 10, 1, 500),#Bug solucionado (Se cambio el tercer digito)
    pygame.Rect(897, 10, 1, 500),#Bug solucionado (Se cambio el tercer digito)
    #los dos primeros digitos, son las cords, y los ultimos son la hitbox
    #al momento de no tener nada en el tercer digito el juego penso que
    #no tendria hitbox horizontal, yo aclaro que no error de pygame
    #es error de la logica ya que esto puede servir para la
    #jugabilidad de un juego plataformero y evitar que te des
    #un cabezaso en la esquina, creo yo. SpartanBeans se retira
]
